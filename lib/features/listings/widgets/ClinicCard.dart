...
import 'package:myapp/features/listings/views/ClinicDetailsPage.dart';
...
class ClinicCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ListView.separated(
      ...
      itemCount: 3, // Show 3 items for demo
  ...
  Widget _buildClinicCard(BuildContext context, {bool isHighlighted = false}) {
    return GestureDetector(
      onTap: () {
        Navigator.push(
          context,
          MaterialPageRoute(builder: (context) => const ClinicDetailsPage()),
        );
      },
      child: Container(
