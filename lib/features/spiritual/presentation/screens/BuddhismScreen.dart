...
class BuddhismScreen extends StatefulWidget {
  final String? bannerImage;

  const BuddhismScreen({
    super.key,
    this.bannerImage,
  });

  @override
  State<BuddhismScreen> createState() => _HinduismScreenState();
}

class _HinduismScreenState extends State<BuddhismScreen> {
