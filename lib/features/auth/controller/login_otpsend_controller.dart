...
class LoginOtpController extends GetxController {
  ...
  Future<bool> sendLoginOtp(BuildContext context, String phone) async {
    ...
    const url = 'https://roll-mngmnt-backend.vercel.app/user/auth/login-otp';
    ...
    try {
      ...
      if (response.statusCode == 200 && responseData['success'] == true) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text(responseData['message']?.toString() ?? "Failed to send OTP."),
  ...
  Future<bool> verifyLoginOtp({
    ...
    const verifyUrl = "https://roll-mngmnt-backend.vercel.app/user/auth/verify-login";
