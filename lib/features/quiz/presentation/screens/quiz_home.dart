...
import 'package:myapp/features/quiz/presentation/screens/game/game_categories.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(
              ...
              child: const GameCategoriesScreen(),
            ),
            // Play Different Zone
            Padding(
            ...
            Padding(
              ...
              child: GridView.count(
                ...
                children: [
                  ...
                  QuizZoneItem.withImage(
                    onTap: () {
                      controller.fetchCategoriesApi("fun").then((_){
                        Navigator.pushNamed(context, QuizRoutes.funLearn);
                        // Get.to(()=> const FunCategoriesScreen());
                      });
                    },
                    title: 'Fun \'N\' Learn',
                  ...
                  QuizZoneItem.withImage(
                    onTap: () {
                      controller.fetchCategoriesApi("true").then((_){
                        Navigator.pushNamed(context, QuizRoutes.trueFalse);
                        // Get.to(()=> const TrueFalseGameScreen());
                      });
                    },
                    title: 'True | False',
                  ...
                  QuizZoneItem.withImage(
                    onTap: () {
                      controller.fetchCategoriesApi("guess").then((_){
                        Navigator.pushNamed(context, QuizRoutes.guessWord);
      ...
      bottomNavigationBar: BottomBarForQuiz(
        selectedIndex: _quizIndex, // Quiz tab
        onItemTapped: (index) {
          _quizIndex = index;
          if (index == 1) {
            // Already on Quiz tab
